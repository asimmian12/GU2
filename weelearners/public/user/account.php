...
<section class="section-banner flex flex-col items-center">
    <h1 class="text-3xl font-semibold text-center mt-6 mb-4 text-pink-500" id="h1-heading-center">Account Details Page</h1>
    <p id="paragraph-text" class="paragraph-text mx-2 text-center">
        Hi <?= htmlspecialchars($_SESSION['name'] ?? '') ?>, Welcome to your Account Details Page! Here you can find all the information related to your account. You can also upload your profile picture and view your personal account information.
    </p>
</section>
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:border-indigo-400 transition-colors duration-200">
                    <div class="space-y-3 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <!-- File input label -->
                            <label for="section-profile-picture" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
